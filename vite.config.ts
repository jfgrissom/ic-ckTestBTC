...
export default defineConfig(async ({ mode }) => {
  ...
  console.log('Vite config environment variables:', {
    ...
    VITE_CANISTER_ID_MOCK_CKTESTBTC_LEDGER:
      env.VITE_CANISTER_ID_MOCK_CKTESTBTC_LEDGER,
    VITE_CANISTER_ID_MOCK_CKTESTBTC_MINTER:
      env.VITE_CANISTER_ID_MOCK_CKTESTBTC_MINTER
  })
  ...
  return {
    ...
    define: {
      ...
      'process.env.CANISTER_ID_MOCK_CKTESTBTC_LEDGER': JSON.stringify(
        env.VITE_CANISTER_ID_MOCK_CKTESTBTC_LEDGER
      ),
      'process.env.CANISTER_ID_MOCK_CKTESTBTC_MINTER': JSON.stringify(
        env.VITE_CANISTER_ID_MOCK_CKTESTBTC_MINTER
      )
    },
    resolve: {
